...
export const FIREBASE_API_KEY = 'AIzaSyCx5VswJGEb2IQ7iTxjSI6UFiVfJWRFafM';
...
export const FIREBASE_DATABASE = `https://phone-store-fe2c3-default-rtdb.firebaseio.com/`;
